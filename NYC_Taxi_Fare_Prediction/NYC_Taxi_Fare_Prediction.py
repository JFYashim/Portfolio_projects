...
@st.cache_resource
def load_assets():
    model = joblib.load("nyc_taxi_rf_model.pkl")
...
st.write(
    "Enter the trip details below to calculate the predicted base fare."
)
...
if assets_loaded:
    ...
    if submit:
        ...
        # Prepare input data matching model feature structure
